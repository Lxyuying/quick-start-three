...
loadDam(scene)
const { composer, outlinePass } = addColor(0xff0000, { camera, scene, renderer })
// 创建背景音乐
// createBCAudio()
//点击模型
window.addEventListener('click', getmodelclick({ camera, scene, outlinePass }))
/**
 * 相机设置
 */
...
document.getElementById('app').append(renderer.domElement) //body元素中插入canvas对象
